...
saveRDS(op_list_w, "G1787-5_GI_op_list.rds")
```

```{r}
op_list_w <- readRDS("G1787-5_GI_op_list.rds")
...
saveRDS(imp_res, "G1787_5_imp_res.rds")
```
...
saveRDS(op_list_w, "G1787-6_GI_op_list.rds")
```

```{r, include=FALSE}
op_list_w <- readRDS("G1787-6_GI_op_list.rds")
...
saveRDS(imp_res, "G1787_6_imp_res.rds")
```

```{r, include=TRUE, echo=FALSE}
# load saved data
imp_res <- readRDS("G1787_6_imp_res.rds")
...
saveRDS(op_list_w, "G1787-7_GI_op_list.rds")
```

```{r, include=TRUE, echo=FALSE}
op_list_w <- readRDS("G1787-7_GI_op_list.rds")
...
saveRDS(imp_res, "G1787_7_imp_res.rds")
```

```{r, include=TRUE, echo=FALSE}
# load saved data
imp_res <- readRDS("G1787_7_imp_res.rds")
...
saveRDS(op_list_w, "G1787-8_GI_op_list.rds")
```

```{r, include=TRUE, echo=FALSE}
op_list_w <- readRDS("G1787-8_GI_op_list.rds")
...
saveRDS(imp_res, "G1787_8_imp_res.rds")
```

```{r, include=TRUE, echo=FALSE}
# load saved data
imp_res <- readRDS("G1787_8_imp_res.rds")
